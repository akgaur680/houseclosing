...
<h2>Redefining Homeownership: Real Estate Mortgages Tailored to Your Ambitions</h2>
...
<img src="assets/images/banner-img-1.jpg" class="img" alt="banner-img">
...
<div class="authentication-area ptb-130">
<div class="container">
<div class="authentication-content">
<div class="row">
<div class="col-lg-5">
<div class="login h-100 text-center">
<img src="assets/images/register.png" class="h-100 object-fit-cover" alt="register">
</div>
</div>
<div class="col-lg-7">
...
<div class="form-group mb-4">
<button type="submit" class="btn btn-warning btn-pill text-white w-100 d-block">
<span>Register</span>
<i class="ti ti-send"></i>
</button>
</div>
<div class="form-group mb-0">
<p class="text-secondary ms-1 text-primary">Already have an account? <a href="/login" class="text-decoration-none text-primary">Login</a></p>
</div>
</form>
</div>
</div>
