...
<div class="banner-area banner-bg-2">
    ...
    <div class="container mw-1570">
        <div class="banner-img">
            <img src="<?php echo e(url('assets/images/banner-4.jpg')); ?>" alt="banner">
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\houseclosing\resources\views\web\tax_calculator.blade.php ENDPATH**/ ?>