                ...
                <div class="card-body">
                      ...
                      <div class="page-banner-content">
                        <ul class="list-unstyled breadcrumbs" style="display:inline-block;">
                            ...
                            <li style="display: inline;">
                                <span class="fs-6" >Add New Lawyer</span>
                            </li>
                        </ul>
                    </div>
                    <div id="add-category-form-container" class="mt-5">
                        ...
                        <form id="create-category-form" action="<?php echo e(route('admin.add-lawyer.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="lawyer_name" name="lawyer_name" placeholder="Name" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="lawyer_designation" name="lawyer_designation" placeholder="Designation"></input>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="lawyer_about" name="lawyer_about" placeholder="About" >
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\houseclosing\resources\views\admin\add_lawyer.blade.php ENDPATH**/ ?>