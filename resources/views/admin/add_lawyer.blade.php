                ...
                <div class="card-body">
                      ...
                      <div class="page-banner-content">
                        <ul class="list-unstyled breadcrumbs" style="display:inline-block;">
                            ...
                            <li style="display: inline;">
                                <a href="{{url('admin/lawyer-member-area')}}" style="text-decoration: none; color:green" class="fw-bold fs-6">Lawyer Members Area/ </a>
                            </li>
                            <li style="display: inline;">
                    ...
                    <div id="add-category-form-container" class="mt-5">
                        ...
                        <form id="create-category-form" action="{{ route('admin.add-lawyer.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
