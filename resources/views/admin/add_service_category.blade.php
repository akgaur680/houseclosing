                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="section2_button_label" name="section2_button_label" placeholder="Section 2 Button Label">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="section2_button_link" name="section2_button_link" placeholder="Section 2 Button Link">
